...
import { ArrowLeft, Target, Plane, Heart, DollarSign, Plus, Trash2, Edit } from "lucide-react";
  ...
  useEffect(() => {
    const fetchAndSetData = async () => {
      ...
      if (travelError) console.error("Error fetching travel goals:", travelError);
        ...
        // Determine top travel goal and set background
